...
from functions import extended_2v2, leave_one_out, get_dim_corr, get_dim_corr_for_numpy
...
def decoding_analysis(X=None, y=None, participant=None, iters=50, loocv=False, permuted=False, current_seed=-1, use_nc=False, brain_type='wholeBrain',
    ...
    if use_nc:
        ...
        if loocv:
            ...
            # Define a shufflesplit because loocv is not being used.
